...
Datafeeds.UDFCompatibleDatafeed.prototype.getServerTime = function (callback) {
  if (this._configuration.supports_time) {
    this._send(this._datafeedURL + '/chart/time', {})
...
Datafeeds.UDFCompatibleDatafeed.prototype._initialize = function () {
  ...
  this._send(this._datafeedURL + '/chart/config')
    .done(function (response) {
...
Datafeeds.UDFCompatibleDatafeed.prototype._symbolResolveURL = '/chart/symbols';
...
Datafeeds.UDFCompatibleDatafeed.prototype._historyURL = '/candles';
...
Datafeeds.UDFCompatibleDatafeed.prototype.getBars = function (symbolInfo, resolution, rangeStartDate, rangeEndDate, onDataCallback, onErrorCallback) {
  ...
  this._send(this._datafeedURL + this._historyURL, {
    ...
    .done(function (response) {
      var data = parseJSONorNot(response);
      var nodata = !data.data || data.data.length === 0;
      ...
      var barsCount = nodata ? 0 : data.data.length;
...
Datafeeds.UDFCompatibleDatafeed.prototype.getQuotes = function (symbols, onDataCallback, onErrorCallback) {
  this._send(this._datafeedURL + '/chart/quotes', { symbols: symbols })
    .done(function (response) {
      var data = parseJSONorNot(response);
      if (data.s === 'ok') {

...
/**
 * 简化版的mobile-detect, 根据需求，只需要pad 和iphone 即可
 * copy from mobile-deteck.js
 * https://github.com/hgoebl/mobile-detect.js/edit/master/mobile-detect.js
 */
...
class MbDetect {
  ...
  findMatch(rules, userAgent) {
    for (const key in rules) {
      if (hasOwnProp.call(rules, key)) {
        const ruleReg = new RegExp(rules[key], 'i');
        if (ruleReg.test(userAgent)) {
          return key;
        }
      }
    }
  ...
  tablet() {
    return this.findMatch(Rules.tablets, this.ua);
  }

  mobile() {
    return this.findMatch(Rules.phones, this.ua);
  }

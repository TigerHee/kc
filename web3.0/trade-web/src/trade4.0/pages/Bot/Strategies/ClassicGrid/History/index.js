    ...
    <TR className={`bot-${item.status}`}>
      ...
      <TD>
        <Text as="div" color="text40" className="sm-two-label">
          <LabelPopover tipKey="gridprofit" straName="GRID">
            {_t('card8')}
          </LabelPopover>
          <span className="sm-split">/</span>
          <LabelPopover tipKey="float" straName="GRID">
            {_t('card9')}
          </LabelPopover>
        </Text>
      ...
      <TD>
        <Text Text as="div" color="text40">
          <LabelPopover tipKey="breakEven" straName="GRID">
            {_t('profitchart1')}
          </LabelPopover>
        </Text>
        <Text as="div" color="text60">
          <FormatNumber value={breakEvenPrice} precision={pricePrecision} />
        </Text>
      </TD>
      <TD>
        <Text as="div" color="text40">

...
const riskCacheKey = 'bot.future.cta.risk.dialog';

export default React.memo(({ form, options, type, clearCoupon, clear }) => {
  ...
  return (
    <>
      ...
      <OrderSureSheet dialogRef={dialogRef} options={options} onSuccess={clear} />
    </>
  );
});

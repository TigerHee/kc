...
const AutoDepositCell = ({ symbol, autoDeposit, trialCode, isTrialFunds, marginMode }) => {
  ...
  const handleChange = useCallback(
    (checkStatus) => {
      ...
      BIClick([POSITIONS_PRD.BLOCK_ID, POSITIONS_PRD.AUTO_DEPOSIT], { marginMode });
      const handle = () => {
        dispatch({
    ...
    [autoDeposit, dispatch, isTrialFunds, marginMode, needTips, symbol, trialCode],
  );

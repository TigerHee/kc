...
const PriceInfo = React.memo(({ price, changeRate, changePrice, fixed, ...otherProps }) => {
    ...
    <Container {...otherProps}>
      <Price>
        <ChangeRender
          value={+price ? price : '--'}
          withPrefix={false}
          render={(v) => <AmountPrecision value={v} fixed={fixed} />}
      ...
      <Change changeRate={changeRate} {...priceChangeColor}>
        {changeRate ? (
          <Fragment>
            ...
            {changePrice > 0 ? '+' : ''}
            <AmountPrecision value={changePrice} fixed={fixed} />
          </Fragment>
        ) : (
          <ChangeRender value={changeRate} withPrefix={changeRate > 0} />
        )}

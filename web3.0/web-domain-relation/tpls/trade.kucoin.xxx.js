window._WEB_RELATION_ = {
  /** 入口地址，同文件名 */
  MAIN_HOST: 'https://www.kucoin.{tld}/trade',
  /** 主站地址 */
  ...
  /** KuMEX地址 */
  KUMEX_HOST: 'https://futures.kucoin.{tld}',
  /** KuMEX简约版地址 */
  KUMEX_BASIC_HOST: 'https://futures.kucoin.{tld}/lite',
  /** PoolX地址 */
  ...
  /** 一键买币项目 地址 */
  FASTCOIN_HOST: 'https://express.kucoin.{tld}',
  /** token-info 地址 */

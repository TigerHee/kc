...
export default extend(base, {
  ...
  state: {
    ...
    positionDetail: {},
    autoLendConfig: {},
    noviceBenefitsVisible: false, // 去掉了新手福利弹窗
    agreement: {},
    marginModalConfig: {
      open: false,
      modalType: 0,
  ...
  reducers: {
    ...
    updateMarginModalConfig(state, { payload = {} }) {
      return {
        ...state,
        marginModalConfig: { ...state.marginModalConfig, ...payload },
      };
    },
    updateLeverageModalConfig(state, { payload = {} }) {
      return {
        ...state,
        leverageModalConfig: { ...state.leverageModalConfig, ...payload },
      };
    },
  },
  effects: {

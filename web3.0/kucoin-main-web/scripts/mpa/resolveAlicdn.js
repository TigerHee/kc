...
const IS_INSIDE_WEB = BUILD_ENV === 'cn';
const IS_TEST_ENV = BUILD_ENV === 'sit';
const IS_SANDBOX = BUILD_ENV === 'sdb';
...
async function getAllCssPaths(distDir) {
...
async function main(distDir) {
  const cssFiles = await getAllCssPaths(distDir);

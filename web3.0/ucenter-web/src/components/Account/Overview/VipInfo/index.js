...
import { VIP_CONFIG, VIP_LEVEL_DATA } from 'routes/VipEquity/config';
...
const vipLevelOptions = [
  ...
  { label: () => _t('f9SnoCgfwpq4EcZ1Dg6hFH'), value: 'spot', unit: window._BASE_CURRENCY_ },
  { label: () => _t('8icM8tbdGqeCT5DUNmp4aM'), value: 'futures', unit: window._BASE_CURRENCY_ },
];

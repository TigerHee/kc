        ...
        <TooltipsWrapper>
          <Item>
            ...
            {securtyStatus?.EMAIL ? (
              ...
              <Desc>
                <a href={addLangToPath('/account/security/email')}>
          ...
          <Item>
            ...
            {securtyStatus?.SMS ? (
              ...
              <Desc>
                <a href={addLangToPath('/account/security/phone')}>
                  {_t('54tW8qq8RMSzEAEXnmbt1q')}
                </a>
              </Desc>
            )}
          ...
          <Item>
            ...
            {securtyStatus?.WITHDRAW_PASSWORD ? (
              ...
              <Desc>
                <a href={addLangToPath('/account/security/protect')}>
                  {_t('54tW8qq8RMSzEAEXnmbt1q')}
                </a>
              </Desc>
            )}
          ...
          <Item>
            ...
            {securtyStatus?.GOOGLE2FA ? (
              ...
              <Desc>
                <a href={addLangToPath('/account/security/g2fa')}>{_t('kMeTCs4CatMrfiGhnqdTgC')}</a>
              </Desc>
            )}
          </Item>
          <TooltipArrow>

...
export const CURRENCY_CHARS = [
  ...
  { currency: 'PEN', char: 'S/.' }, // country: '秘鲁(索尔)'
  { currency: 'KES', char: 'KSh' }, // country: '肯尼亚(先令)'
  { currency: 'SAR', char: 'ر.س' }, // country: '沙特阿拉伯(里亚尔)'
  { currency: 'UGX', char: 'USh' }, // country: '乌干达(先令)'
  { currency: 'MAD', char: 'م.د.' }, // country: '摩洛哥(迪拉姆)'
  { currency: 'BOB', char: '$b' }, // country: '玻利维亚(玻利维亚诺)'
  { currency: 'HUF', char: 'Ft' }, // country: '匈牙利(福林)'
  { currency: 'AED', char: 'د.إ' }, // country: '阿联酋(迪拉姆)'
  { currency: 'EGP', char: '£' }, // country: '埃及(镑)'
  { currency: 'MNT', char: '₮' }, // country: '蒙古(图格里克)'
  { currency: 'VES', char: 'Bs' }, // country: '委内瑞拉(玻利瓦尔)'
  { currency: 'ISK', char: 'kr' }, // country: '冰岛(克朗)'
];

const currencyMap = {};
const getCurencyMap = () => {
  forEach(CURRENCY_CHARS, (item) => {

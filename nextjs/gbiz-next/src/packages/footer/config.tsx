...
export const FOOTER_LINKS = ({ _t: t }) => {
  ...
  return [
    {
      ...
      links: [
        ...
        // 博客
        { path: '/blog', title: t('kQJcNp74AZrCipYvvgCwSz'), isUKForbidden: true,  hidden: !tenantConfig.showBlog, },
        {
          path: '/announcement',
          // 新聞與公告
        ...
        // KuCoin Labs
        { path: '/land/kucoinlabs', title: t('awLYFWz9yR992xZXK6e6hw'), isUKForbidden: true, hidden: !tenantConfig.showKucoinlabs, },
        // KuCoin Ventures
        { path: '/kucoin-ventures', title: t('7KUELV6LEovqKB8wivnD9P'), isUKForbidden: true, hidden: !tenantConfig.showVentures, },
        // 儲備證明 (PoR)
        { path: '/proof-of-reserves', title: t('kZsUg7gv3Fvwe7zrKHYcgj'), hidden: !tenantConfig.showPoR, },
        // 安全
    ...
    },
    {
      ...
      links: [
        // 快捷买币 Fast Trade
        {
          ...
          hidden: !bootConfig._SITE_CONFIG_.functions.fast_trade,
        },
        // 閃兌
        {
          path: '/convert',
          title: t('rRy9gSPVNvPyKfRELzyisV'),
          hidden: !bootConfig._SITE_CONFIG_.functions.convert,
        },
        // KuCard
        {
          path: '/kucard',
          title: t('ed11460d3f404000a3d5'),
          hidden: !bootConfig._SITE_CONFIG_.functions.kucard,
        },
        // KuCoin Pay，不需要翻译。
        {
          path: '/pay',
          ...
          hidden: !bootConfig._SITE_CONFIG_.functions.kucoin_pay,
        },
        // 幣幣交易
        {
          path: '/trade',
          title: t('fCWmC8LaDTJGrVn7jXnZfS'),
          hidden: !bootConfig._SITE_CONFIG_.functions.spot,
        },
        // 合約交易
        {
          path: '/trade/futures',
          title: t('gjQ2yNC8XMHLsYxAhzVqcq'),
          hidden: !bootConfig._SITE_CONFIG_.functions.futures,
        },
        // 杠杆交易
        {
          path: '/trade/margin',
          title: t('tDXzFgZq9mzpuq29Ved9Pm'),
          hidden: !bootConfig._SITE_CONFIG_.functions.margin,
        },
        // ETF
        {
          path: '/leveraged-tokens',
          title: t('45a2aec83abd4000a0b7'),
          hidden: !bootConfig._SITE_CONFIG_.functions.etf,
        },
        // KuCoin 賺幣
        {
          path: '/earn',
          title: t('6fVt1h7VKhyG3P9pSFt1kz'),
          hidden: !bootConfig._SITE_CONFIG_.functions.financing,
        },
        // 借貸
        {
          path: '/margin/v2/lend',
          title: t('govVuuMQHJdpA2iu74WJE5'),
          hidden: !bootConfig._SITE_CONFIG_.functions.lend,
        },
        // 交易機器人
        {
          path: '/trade/strategy',
          title: t('reYejUEydTvkDjribM4zQB'),
          hidden: !bootConfig._SITE_CONFIG_.functions.trading_bot,
        },
        // 邀請好友
        {
          path: '/referral',
          ...
          isUKForbidden: true,
          hidden: !bootConfig._SITE_CONFIG_.functions.invite_rebate,
        },
        // GemSpace
        {
          path: '/gemspace',
    ...
    },
    {
      ...
      links: [
        ...
        {
          // 技術支持
          path: '/news/en-kucoin-launches-the-technical-support-channel-to-help-users-find-the-solution',
        ...
        // KuCoin 官方驗證中心
        { path: '/cert', title: t('4nXLsUXUpHgN7ToU2SM5Vj') },
        // 費用及VIP
...
export const TR_FOOTER_LINKS = ({ _t: t }) => {
...
export const TH_FOOTER_LINKS = ({ _t: t, isH5 }) => {
  const currentLang = getCurrentLang();
  const baseList = [
    {
      //  公司
    ...
    },
    {
      ...
      links: [
        ...
        // 幣幣交易 Spot Trading
        {
          ...
          title: t('fCWmC8LaDTJGrVn7jXnZfS'),
          // @ts-ignore
          hidden: !getSiteConfig()?.functions?.spot,
        },
        {

      ...
      <div>
        ...
        <p>
          <Trans
            ...
            ns="footer"
            values={{ url: addLangToPath(`${KUCOIN_HOST}/support/categories/47134508281145`, currentLang) }}
            components={{
              a: (
                // eslint-disable-next-line jsx-a11y/control-has-associated-label
                <a
                  href={addLangToPath(`${KUCOIN_HOST}/support/categories/47134508281145`, currentLang)}
                  target="_blank"
                />
              ),
            }}

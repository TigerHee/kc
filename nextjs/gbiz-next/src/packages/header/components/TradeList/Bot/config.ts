...
const MORE = 'MORE';
const DFT_SPOT_SYMBOL = `BTC-${bootConfig._BASE_CURRENCY_}`;
// 多站点展示
...
export const getBotList = (machineMap = {}) => {
  const lists = getTenantConfig().botGlobalListShow() ? strategyLists : strategyListsShareSite;

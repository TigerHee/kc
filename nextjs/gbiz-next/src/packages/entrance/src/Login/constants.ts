...
export enum LOGIN_STEP {
  ...
  // 绑定注册/新流程
  SIGN_IN_STEP_BIND_THIRD_PARTY_NEW = 5,
  // 三方注册 极简注册
  SIGN_IN_STEP_THIRD_PARTY_SIMPLE = 6
};

// 输入账号登陆
export enum ACCOUNT_LOGIN_STEP {
  // 仅展示账号输入框
...
// 三方注册分流 步骤
export enum THIRD_PARTY_ACCOUNT_DIVERSION_STEP {
  // 首页
  HOME = 0,
  // 创建新账户页面
...
export enum THIRD_PARTY_LOGIN_DECISION {
  // 三方账号直接登陆
  login = 1,
  // 三方换绑
  relink = 2,
...
export interface AccountKey {
  mobileCode: string;
  [ACCOUNT_LOGIN_TAB_KEY]: string;
  [SUB_ACCOUNT_LOGIN_TAB_KEY]: string;
}

export const ACCOUNT_KEY: AccountKey = {

...
export const getTransferCurrencies = (params) => {
  return post(`/account-biz-front/transfer/currencies`, params, false, true);
};

export const getTransferCurrenciesV2 = (params) => {
  return post(`/account-biz-front/v2/transfer/currencies`, params, false, true);
};

export const getCombineTransferCurrencies = (params) => {
  return post(`/account-biz-front/combine/transfer/currencies`, params, false, true);
};
...
export const getCombineTransferBalance = (params) => {
  return post(`/account-biz-front/combine/transfer/query-balance`, params, false, true);
};
...
export const querySupportBatchV2 = (params) => {
  return post(`/account-biz-front/transfer/aggregate-check`, params, false, true);
};

// 账户间划转
export const transferApply = (params) => {
  return post(`/account-biz-front/self-transfer`, params, false);
};

// 账户顺序划转
export const multiTransferApply = (params) => {
  return post(`/account-biz-front/combine/transfer`, params, false, true);
};
...
export const transferBatchApply = (params) => {
  return post(`/account-biz-front/transfer/batch-transfer`, params, false, true);
};

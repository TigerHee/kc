...
import { DEFAULT_FIAT, DEFAULT_CURRENCY, INIT_DIRECTION } from '../constants';
...
export const PropsProvider = ({ value, children }) => {
  const _value = useMemo(() => {
    const { transferConfig, visible, reOpen, onClose, userInfo, currentLang } = value;
    const { initDict, initCurrency: currency, callback, supportAccounts } = transferConfig;
    const [pay, rec] = initDict || INIT_DIRECTION;

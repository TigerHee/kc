...
export const DEFAULT_BASE_Z_INDEX = 50;
...
export interface IStickyItemHandle {
   ...
   * @param offsetTop 当前最新的置顶需要距离视口顶部的偏移量
...
export interface IStickyContextValue {
  /**
   * sticky 元素的基准 z-index
   */
  baseZIndex: number;
  /**
   * 注册需要 sticky 的元素
...
export const StickyContext = createContext<IStickyContextValue | null>(null);

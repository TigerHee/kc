...
export function useCommonProps(props: DatePickerProps) {
  const { onChange, format, value, inFocus, disabled, allowClear, ...resetProps } = props;

  return React.useMemo(() => {
    const clearIcon = (
      <div className="kux-date-picker__icon kux-date-picker__icon--clear">
    ...
    return {
      ...
      locale: en_US,
      popupClassName: 'kux-date-picker-dropdown',

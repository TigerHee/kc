...
import { VERIFY_ITEM } from 'routers/AccountPage/Kyc/config';
...
export default extend(base, {
  ...
  effects: {
    ...
    *submitKycCompMoreImg({ payload }, { call }) {
    ...
    //获取高级认证渠道
    *getKyc2Channel({ payload }, { call, put }) {
      try {

  ...
  effects: {
    *getAccountList({ payload }, { call, put, select }) {
      try {
        ...
        const data = yield call(serv.getSubAccountListWithAssets, {
          ...
          keywords,
          filterRobot: true,
          balanceCurrency: baseCurrency || balanceCurrency || bootConfig._BASE_CURRENCY_,
          baseAmount,
    ...
    *getSubAccountAmount({ payload }, { call, put, select }) {
      ...
      const { data } = yield call(serv.getSubAccountAmount, {
        baseCurrency: baseCurrency || balanceCurrency || bootConfig._BASE_CURRENCY_,
        baseAmount,
      });
      ...
      if (stateAccountsMoney && stateAccountsMoney[subName]) {
        yield put({
          ...
          payload: {
            ...
            baseCurrency:
              stateBaseCurrency || baseCurrency || balanceCurrency || bootConfig._BASE_CURRENCY_,
          },
        });
        yield put({

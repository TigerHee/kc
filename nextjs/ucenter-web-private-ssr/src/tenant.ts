...
const defaultConfig = (() => {
  ...
  return {
    siteRoute: 'KC_ROUTE',
    common: {
      forceLightTheme: false, // 是否强制白天主题
    ...
    account: {
      ...
      balanceOptions: () => [
        // 个人概览 资产单位
        { value: bootConfig._BASE_CURRENCY_, label: bootConfig._BASE_CURRENCY_ },
        { value: 'BTC', label: 'BTC' },
        { value: 'KCS', label: 'KCS' },
      ],
    ...
    resetSecurity: {
      ...
      supportUrl: siteConfig.KUCOIN_HOST + addLangToPath('/support/requests'),
    },
    delete: {
      tips: (_t) => [
        _t('315tkjrnwNKJE1nW8qrCoY'),
        _t('account.del.influence3'),
        _t('qaGpEJ626ZW1muMQg3w3gK'),
        _t('account.del.influence5'),
        _t('d6d41e328f3a4000a1b7'),
      ],
      showShortNoteMsg: false,
    },
  };
})();
...
const EU = merge({}, defaultConfig, {
  ...
  delete: {
    tips: (_t) => [_t('qaGpEJ626ZW1muMQg3w3gK'), _t('a93a902f03c24000a4b1')],
    showShortNoteMsg: true,
  },
});
...
const CL = (() => {
  ...
  return merge({}, defaultConfig, {
    ...
    resetSecurity: {
      supportBot: false,
      // 申领站没有客服页面，跳到主站的客服页面
      notSupportBotUrl: siteConfig.KC_SITE_HOST + addLangToPath('/support'),
...
export const getTenantConfig = () =>
  tenantConfigMap[bootConfig._BRAND_SITE_ as keyof typeof tenantConfigMap] || KC;

 ...
 * @todo gbiz-next 还没支持模块联邦
 */
// import { moduleFederation } from 'gbiz-next/common-base';
...
const AssetsWebCompManager = {
  ...
  get SubUnifiedAccount() {
    if (!_SubUnifiedAccount) {
      _SubUnifiedAccount = loadRemote('assets-web/SubUnifiedAccount');
    }
    return _SubUnifiedAccount;
  },

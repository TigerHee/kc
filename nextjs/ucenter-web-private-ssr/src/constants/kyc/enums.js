...
export const KYC_CERT_ENUM = {
  ...
  /** 欧洲基础 KYC 认证 CRA 补充 */
  EU_BASIC_KYC_CRA: 'EU_BASIC_KYC_CRA',
  /** 欧洲高级认证 */
...
export const KYC_CERT_PASSED_ENUM = {
  ...
  [KYC_CERT_ENUM.EU_BASIC_KYC]: [KYC_LABEL_ENUM.EU_KYC_CRA, KYC_LABEL_ENUM.EU_ADVANCE],
  [KYC_CERT_ENUM.EU_BASIC_KYC_CRA]: [KYC_LABEL_ENUM.EU_KYC_CRA],

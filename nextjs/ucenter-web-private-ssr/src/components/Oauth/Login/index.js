...
import { LoginNoLayout as LoginComponent } from 'gbiz-next/entrance';
import { px2rem, styled, useSnackbar, useTheme } from '@kux/mui';
    ...
    <Wrapper>
      <div style={{ width: rv.md ? 480 : '100%' }}>
        <LoginComponent
          ...
          onForgetPwdClick={() => {
            const url = `${getSiteConfig().KUCOIN_HOST}/ucenter/reset-password`;

...
import { styled, Table, Tabs } from '@kux/mui';
...
import { find, isBoolean, throttle } from 'lodash-es';
...
const OverviewMarket = ({ init }) => {
  ...
  if (init && (!multiSiteConfig || !marketMultiSiteConfig)) {
    return null;
  }

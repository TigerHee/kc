...
import { Avatar, Divider, styled, useSnackbar, useTheme } from '@kux/mui';
...
import ModalBindHostedToken from 'routes/AccountPage/SubAccount/modalBindHostedToken.js';
...
const ExInfoIcon = styled(InfoFilledIcon)`
  margin: 1px;
  color: inherit;
`;

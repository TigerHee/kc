        ...
        {modalOpen === 'modalTrans' ? (
          this.state.isUseNewTransferModal ? (
            <UniversalTransferModal
              ...
              initCurrency={bootConfig._BASE_CURRENCY_}
              initDict={
                curItem.type === 9
                  ? [
...
const PageSubAccountWithLayout = (props) => {
  return (
    <ErrorBoundary scene={SCENE_MAP.subAccount.index}>
      <AccountLayout>
        <PageSubAccount {...props} />
      </AccountLayout>
    </ErrorBoundary>
  );
};
export default PageSubAccountWithLayout;

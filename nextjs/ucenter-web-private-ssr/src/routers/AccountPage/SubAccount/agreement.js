...
const urls = () => {
  ...
  return [
    `${KUCOIN_HOST}/announcement/en-futures-terms-of-use`,
    `${KUCOIN_HOST}/legal/en-terms-of-use`,
    `${KUCOIN_HOST}/announcement/en-futures-privacy-policy`,
    `${KUCOIN_HOST}/announcement/en-futures-risk-disclosure-statement`,
  ];
};

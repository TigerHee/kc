...
import Table from 'components/Account/Download/Table';
...
@injectLocale
class AccountDownloadPage extends React.Component {
  componentDidMount() {
    this.props.dispatch({
...
const DownloadPageWithLayout = (props) => {
  return (
    <AccountLayout>
      <AccountDownloadPage {...props} />
    </AccountLayout>
  );
};

export default withRouter()(DownloadPageWithLayout);

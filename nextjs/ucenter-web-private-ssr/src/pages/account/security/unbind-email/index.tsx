...
const PageRouterComponent = safeDynamic(() => import(/* webpackChunkName: "r__account__security__unbind-email__index" */ '@/routers/AccountPage/Security/UnbindEmail/index'), {
  ssr: false,
});

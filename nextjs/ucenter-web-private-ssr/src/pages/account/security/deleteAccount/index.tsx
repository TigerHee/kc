...
const PageRouterComponent = safeDynamic(() => import(/* webpackChunkName: "r__account__security__deleteAccount__index" */ '@/routers/AccountPage/Security/DeleteAccount/index'), {
  ssr: false,
});

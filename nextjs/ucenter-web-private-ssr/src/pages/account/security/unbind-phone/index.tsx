...
const PageRouterComponent = safeDynamic(() => import(/* webpackChunkName: "r__account__security__unbind-phone__index" */ '@/routers/AccountPage/Security/UnbindPhone/index'), {
  ssr: false,
});

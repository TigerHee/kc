...
const PageRouterComponent = safeDynamic(() => import(/* webpackChunkName: "r__account__kyc__institutional-kyc__index" */ '@/routers/AccountPage/Kyc/InstitutionalKyc'), {
  ssr: false,
});
...
const activeSiteConfig = () => {
  ...
  return !tenantConfig.kyc.upgrade && ['TR_ROUTE'].includes(tenantConfig.siteRoute);
};

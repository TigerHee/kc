...
const PageRouterComponent = safeDynamic(() => import(/* webpackChunkName: "r__ucenter__reset-security__token__token__index" */ '@/routers/Ucenter/ResetSecurityWithToken/index'), {
  ssr: false,
});

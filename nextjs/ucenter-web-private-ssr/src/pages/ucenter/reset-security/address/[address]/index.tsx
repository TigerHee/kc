...
const PageRouterComponent = safeDynamic(() => import(/* webpackChunkName: "r__ucenter__reset-security__address__address__index" */ '@/routers/Ucenter/ResetSecurityWithAddress/index'), {
  ssr: false,
});

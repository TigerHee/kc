...
const PageRouterComponent = safeDynamic(() => import(/* webpackChunkName: "r__account-sub__api-manager__edit__presecurity__sub__index" */ '@/routers/AccountPage/SubApiManage/EditPreSecurity'), {
  ssr: false,
});

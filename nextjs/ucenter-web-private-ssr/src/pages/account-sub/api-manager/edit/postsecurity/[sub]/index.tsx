...
const PageRouterComponent = safeDynamic(() => import(/* webpackChunkName: "r__account-sub__api-manager__edit__postsecurity__sub__index" */ '@/routers/AccountPage/SubApiManage/EditPostSecurity'), {
  ssr: false,
});

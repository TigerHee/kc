...
const nextConfig = {
  ...
  webpack: (config, { isServer, webpack }) => {
    ...
    config.resolve.alias = {
      ...config.resolve.alias,
      tools: require('path').resolve(__dirname, 'src/tools'),
      ...
      routers: require('path').resolve(__dirname, 'src/routers'),
      components: require('path').resolve(__dirname, 'src/components'),
      helper: require('path').resolve(__dirname, 'src/helper'),
      api: require('path').resolve(__dirname, 'src/api'),
      hooks: require('path').resolve(__dirname, 'src/hooks'),
      codes: require('path').resolve(__dirname, 'src/codes'),
      routes: require('path').resolve(__dirname, 'src/routers'),
      hocs: require('path').resolve(__dirname, 'src/hocs'),

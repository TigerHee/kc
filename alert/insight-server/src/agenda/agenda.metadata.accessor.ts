...
import type { AgendaModuleOptions, JobDefinitionOptions, JobScheduleOptions } from './types';
...
export class AgendaMetadataAccessor {
  ...
  public canProcessJobs(target: Function) {
    ...
    return this.reflector.get<boolean | undefined>(AGENDA_PROCESSOR_METADATA, target);
  }

  public getJobDefinitionOptions(target: Function) {
    return this.reflector.get<JobDefinitionOptions | undefined>(AGENDA_DEFINE_JOB_METADATA, target);
  }

  public getJobScheduleOptions(target: Function) {
    return this.reflector.get<JobScheduleOptions | undefined>(AGENDA_SCHEDULE_JOB_METADATA, target);
  }
}

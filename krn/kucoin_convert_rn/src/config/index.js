...
export const storagePrefix = 'kucoin_convert_rn';
...
export const PageIdMap = {
  ConvertCoinList: 'BSfastTradeCoinChoose',
  ConvertIndex: 'BSfastTrade',
  CovertHistory: 'BSfastTradeHistory',
  ConvertResult: 'BSfastTradeResult',
};

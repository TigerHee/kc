...
class Swipeable extends PureComponent {
  ...
  initOpenLeft = (
    ...
    const { leftButtonWidth, leftButtons } = this.props;
    const offset = leftButtonWidth * leftButtons.length;
  ...
  initOpenRight = (
    ...
    const { pan } = this.state;
    const { rightButtonWidth, rightButtons } = this.props;
    const offset = rightButtonWidth * rightButtons.length;

...
class SeoSitemapWebHandler extends BaseProjectHandler {
  ...
  async genRoutes(params) {
    ...
    for (const routeSet of params.routeSets) {
      ...
      switch (routeSet) {
        case 'sitemap':
          currentRoutes = await genSitemapRoutes.call(this, params.langs);
          break;
        default:
          break;
      }
...
module.exports = SeoSitemapWebHandler;

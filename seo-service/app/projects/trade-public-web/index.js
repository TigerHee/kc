...
const genSpotRoutes = require('./gen-spot-routes');
const genFuturesRoutes = require('./gen-futures-routes');
...
class TradePublicHandler extends BaseProjectHandler {
  constructor(configs, puppeteerManager, messenger) {
    ...
    this.config = configs.projectConfigs['trade-public-web'];
    ...
    for (const routeSet of params.routeSets) {
      ...
      switch (routeSet) {
        case 'default':
          ...
          break;
        case 'spot':
          currentRoutes = await genSpotRoutes.call(this);
          break;
        case 'futures':
          currentRoutes = await genFuturesRoutes.call(this);
          break;
        default:
          break;
      }

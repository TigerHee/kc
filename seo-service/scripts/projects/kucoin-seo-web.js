...
const routes = null;
const distDirName = 'kucoin-seo-web';

module.exports = {
  projectName: distDirName,
  distDirName,
  distConfig: resolveProjectDist(distDirName, rootDistConfigs),
  entry: '', // seo-web, main-web 和 public-web 不区分 entry
  supportLangs: [],
  routes,
  routeSets: ['how-to-buy', 'converter'],
  mobileGen: true,
  resolveContentConfig: {
    ...
    moveToBodyHeadScriptPatterns: ['/kucoin-seo-web/'],
  },
};

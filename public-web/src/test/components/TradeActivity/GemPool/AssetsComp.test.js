...
import AssetsComp from 'TradeActivity/GemPool/containers/ProjectItem/AssetsComp.js';
...
describe('AssetsComp', () => {
  ...
  it('renders AssetsComp with mini', () => {
    ...
    expect(buttons1[3]).toBeInTheDocument();
    expect(buttons1[4]).toBeInTheDocument();
    fireEvent.click(buttons1[0]);
    fireEvent.click(buttons1[1]);
    fireEvent.click(buttons1[2]);
    fireEvent.click(buttons1[3]);
    fireEvent.click(buttons1[4]);
  });

 ...
 * @LastEditTime: 2024-08-19 12:38:10
 * @FilePath: /public-web/.offconfig.js
 * @Description:
 */
...
const config = {
  ...
  globPatterns: [
    ...
    // 业务上:
    // '**/p__votehub*.js',// 投票上币
    // '**/p__pre-market*.js',// 盘前交易
    // '**/p__rocket-zone*.js',// gemspace
    // '**/p__gempool*.js',// gempool
    // '**/p__slothub*.js',// gemslot
  ],

...
const FormItemRender = ({
  ...
  const getInitialValue = () => {
    ...
    const val =
      formData[complianceMetaCode] || complianceMetaData || componentDefaultMetaData || ocrVal;
  ...
  const FormItemRenderComponent =
    (componentType === 0
      ? FormItemRenderComponentMap[componentCode]
      : FormItemRenderComponentMap[componentType]) || EmptyCom;

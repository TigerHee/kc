...
import ExposeTrack from '@transfer/components/ExposeTrack';
import { kcsensorsClick as trackClick } from '@packages/transfer/src/utils/ga.js';
          ...
          <>
            ...
            <ExposeTrack exposeCondition={itemValue === 'MULTI'}>
              <button
                ...
                onClick={() => {
                  if (isMulti) {
                    trackClick(['transferPopup', 'selectFromAccount'], {
                      account: 'multi',
                    });
                  }
                  if (hasSubLevel) {

...
export function useStateFieldsDeps() {
  ...
  const payConfig = useMemo(() => getConfigByAccount(payAccountType), [
    getConfigByAccount,
    payAccountType,
  ]);
  const recConfig = useMemo(() => getConfigByAccount(recAccountType), [
    getConfigByAccount,
    recAccountType,
  ]);
  ...
  const _payConfig = useMemo(() => getConfigByAccount(_payAccountType), [
    getConfigByAccount,
    _payAccountType,
  ]);
  const _recConfig = useMemo(() => getConfigByAccount(_recAccountType), [
    getConfigByAccount,
    _recAccountType,
  ]);

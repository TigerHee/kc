 ...
 */
import { styled, Global, isPropValid, useTheme } from '@kux/mui';

import { ICSearchOutlined, ICArrowUpOutlined } from '@kux/icons';
...
export const KcCascaderWrapper = styled.div`
  ...
  .pickerArrow {
    ...
    border-top-color: #01081e !important;
    ...
    <Global
      styles={{
        '.kcCascader-popup': {
          ...
          fontSize: '13px',
          whiteSpace: 'nowrap',
          background: theme.currentTheme === 'light' ? '#fff' : '#222223',
          borderRadius: '8px',
        ...
        '.kc-cascader-20210430-menu': {
          ...
          '&-item': {
            ...
            padding: '16px',
            color: theme.currentTheme === 'light' ? '#262627' : '#fbfbfb',
            fontSize: '16px',
            fontWeight: 500,
            cursor: 'pointer',
            '&:hover': {

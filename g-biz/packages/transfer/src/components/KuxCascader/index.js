 ...
 */
import React, { isValidElement, useCallback, useRef, useState, useEffect, useMemo } from 'react';
...
import iconCloseBack from '../../../static/ic_close_back.svg';
import iconCloseBackDark from '../../../static/ic_close_back_dark.svg';
        ...
        <Dropdown currentLevel={inputValue ? 0 : currentLevel}>
          {currentLevel > 0 && (
            <Adden>
              ...
              >
                <img src={isDark ? iconCloseBackDark : iconCloseBack} alt="" />
              </a>
              {showSearch && (
                <Input
                  disabled={disabled}
  ...
  return (
    <KcCascaderWrapper>
      <RcCascader
        ...
        expandIcon={!isRTL ? <ICArrowRightOutlined size="14" /> : <ICArrowLeftOutlined size="14" />}
      ...
      >
        {children || (
          <span
            ...
            data-inspector={props['data-inspector']}
          >

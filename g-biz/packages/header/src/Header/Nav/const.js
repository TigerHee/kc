...
import { ICBonusOutlined } from '@kux/icons';
...
export const genRewardsHubItem = (t, currentLang, host) => ({
  id: REWARDS_HUBS_ENTRY,
  name: t('vDvWFPENu1ofVwJrsY6FMk'),
  uri: addLangToPath(`${host}/KuRewards`, currentLang),
  buttonName: 'KuRewards',
  // 在小比例下以icon形态展示
  simpleIcon: <ICBonusOutlined size="16" color="#01BC8D" />,
  onClick: () => {
...
export const genAffiliateHubItem = (t, currentLang, host) => ({
  id: AFFILIATE_HUBS_ENTRY,
  name: t('jbhR9Z1WXwVEptqnCj5hmQ'),
  uri: addLangToPath(`${host}${newAffPath}`, currentLang),

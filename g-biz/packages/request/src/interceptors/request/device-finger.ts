...
import { RequestInterceptor, FingerPrintUrl, RuntimeEnvironment } from '../../types';

// 低于该版本H5无法使用app的设备指纹token
const SUPPORT_APP_TOKEN = '3.66.0';

const matchUrl = (fingerPrintUrlList: FingerPrintUrl[], requestUrl?: string, method?: string) => {
  if (!requestUrl) {
    return undefined;
  }

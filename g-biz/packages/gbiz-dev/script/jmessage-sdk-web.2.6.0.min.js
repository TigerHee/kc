  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      (l.prototype.init = function(t) {
            ...
            n = new a(this.channel)
              ...
              .addHook(function(n, o) {
                (e.current_user = t.username),
                  ...
                  (e.channel.ses_key = s.SESSION_KEY + e.current_appkey + '-' + e.current_user),
                  (e.channel.conversations_key =
                    s.CONVERSATION_KEY + e.current_appkey + '-' + e.current_user),
                  (e.channel.event_key = s.EVENT_KEY + e.current_appkey + '-' + e.current_user),
                  e._syncCheckTask(),
        ...
        (l.prototype._initConversation = function() {
          ...
          null === e &&
            ((e = JSON.stringify({})), h.StorageUtils.addItem(t.channel.conversations_key, e)),
            ...
            t
              ...
              .onSuccess(function(e) {
                e &&
                  ...
                  h.StorageUtils.addItem(t.channel.event_key, e.sync_event_key));
              }),
        ...
        (l.prototype.updateSelfAvatar = function(t) {
          ...
          return (
            this.__uploadFile(
              ...
              function(t, n) {
                if (t)
                  return t.is_timeout ? e.timeout && e.timeout(t.data) : e.fail && e.fail(t.data);
        ...
        (l.prototype.updateSelfPwd = function(t) {
          return (
            this.__checkLogin(),
            t.is_md5 || ((t.old_pwd = p(t.old_pwd)), (t.new_pwd = p(t.new_pwd))),
            new a(this.channel)
          ...
          return new a(this.channel)
            ...
            .addHook(function(e, n) {
              e.conversations.forEach(function(e) {
                var n;
                3 === e.type
                  ? ((t[e.key] = e.utime), delete e.utime, (n = e.appkey + e.username))
                  : ((n = e.key), (e.gid = e.key)),
                  t.conversations[n]
                    ? (t.conversations[n].extras
                        ? (e.extras = t.conversations[n].extras)
                        : (e.extras = {}),
                      (e.unread_msg_count = t.conversations[n].unread_msg_count))
                    : ((e.extras = {}),
        ...
        (l.prototype.resetUnreadCount = function(t) {
          ...
          t.gid
            ? (e = String(t.gid))
            : (t.appkey || (t.appkey = n.current_appkey), (e = t.appkey + t.username)),
            (n.conversations[e] = void 0 === n.conversations[e] ? {} : n.conversations[e]),
            t.gid
              ? n._updateGroupUnreadCount({ gid: t.gid })
              : n._updateSingleUnreadCount({ appkey: t.appkey, username: t.username }),
          ...
          n.lastMsgs[e] && (o = n.lastMsgs[e].last_msg_time),
            ...
            h.StorageUtils.addItem(n.channel.conversations_key, JSON.stringify(n.conversations));
        }),
        (l.prototype.getUnreadMsgCnt = function(t) {
          ...
          return (
            ...
            n.conversations[e].unread_msg_count ? n.conversations[e].unread_msg_count : 0
          );
        }),
        ...
        (l.prototype.sendChatroomMsg = function(t) {
          return (
            ...
            t.target_rname ||
              (t.target_rname =
                void 0 === h.Cache.rooms[t.target_rid] ? '' : h.Cache.rooms[t.target_rid].name),
            this.__sendMsg({
              type: 'chatroom',
          ...
          Array.prototype.push.apply(
            ...
            t.messages.forEach(function(t) {
              ...
              t.from_appkey === e.current_appkey &&
                ...
                ((r = !0),
                (o =
                  (void 0 === t.content.target_appkey || '' === t.content.target_appkey
            ...
            h.StorageUtils.addItem(e.channel.conversations_key, JSON.stringify(e.conversations)),
          ...
          if (200 !== t.event_type) {
            ...
            if (
              (56 === t.event_type && 10 == t.extra
                ...
                : 56 === t.event_type && 59 == t.extra && ((n.by_self = !0), delete n.extra),
              1 === t.event_type)
            ) {
              var o = {
                event_id: t.event_id,
            ...
            t.messages &&
              (t.messages.forEach(function(t) {
                ...
                if (e.current_conversation === n)
                  (e.conversations[n] = void 0 === e.conversations[n] ? {} : e.conversations[n]),
                ...
                t.events.forEach(function(o) {
                  if (200 === o.event_type)
                    3 === o.description.type
                      ...
                      : e._dealMutlReadEvent(o.description.type, o.ctime_ms, o.description.gid);
                  else {
                    var r = e.__eventDateFilter(o);
                    56 === t.event_type && 10 == t.extra
                      ? (delete r.extra, (r.by_self = !1))
                      : 56 === t.event_type && 59 == t.extra && (delete r.extra, (r.by_self = !0)),
                      n.push(r);
                  }
                }),
                  e._onSyncEventFn(n);
        ...
        (l.prototype._dealMutlReadEvent = function(t, e, n, o) {
          ...
          if (
            ...
            (i.conversations[r].unread_msg_count = 0), (i.conversations[r].msg_time = []);
          else {
        ...
        (l.prototype._receiptReport = function() {
          if (this.report.length > 0) {
            ...
            for (var n = 0; n < e.length; n++)
              (e[n].result.msg_ids = h.ArrayUtils.delRepeatItem(e[n].result.msg_ids)),
        ...
        (l.prototype.__uploadFile0 = function(t, e) {
          ...
          n.open('POST', this.opts.upload_file + '?type=' + t.type),
            ...
            n.setRequestHeader('Authorization', 'Basic ' + r.btoa(t.username + ':' + t.token)),
        ...
        (l.prototype.__uploadFile = function(t, e) {
          ...
          o(function(t) {
            ...
            .then(function(e, o) {
              n.__uploadFile0(
                { type: t.type, file: t.file, appkey: t.appkey, username: t.username, token: o },
                e,
              );
            })
            .then(function(t, n) {
        ...
        (l.prototype.__sendPic = function(t) {
          ...
          return (
            t.file
              ...
              : e.setData(n.setImage(t.msg_body, t.msg_body.extras).build()).send(),
            e
          );
        }),
        (l.prototype.__sendFile = function(t) {
          ...
          return (
            t.file
              ...
              : e.setData(n.setFile(t.msg_body, t.msg_body.extras).build()).send(),
            e
          );
        }),
      ...
      (function(n) {
        !(function(n, s) {
          ...
          'object' == typeof t && 'object' == typeof t.exports
            ? (t.exports = s())
            : ((r = []),
              void 0 === (i = 'function' == typeof (o = s) ? o.apply(e, r) : o) || (t.exports = i));
          ...
          function d(t, e) {
            ...
            return (
              (n._isCont = !0), e && ((h.debug = 'function' == typeof e ? e : E), (t._chain = 1)), n
            );
          }
          function _(t, e, n) {
            var o = new p();
          ...
          function g(t, e) {
            ...
            function a(e) {
              function r(r, i) {
                if (!(n <= 0))
                  return null == r ? ((o[e] = i), !--n && t(null, o)) : ((n = 0), void t(r));
              }
          ...
          function m(e, n) {
            ...
            function p(i, h) {
              return null != i
                ? e(i)
                : ((s[o] = h),
                  ++o > r ? e(null, s) : void (--u > 0 ? a : ((u = t), c))(e, n[o], p));
            }
            (p._isCont = !0), n[0](p);
          }
          function v(t, e, n) {
          ...
          function k(t, e) {
            return new Error(
              'The argument ' + (t && t.toString()) + ' in "' + e + '" is not Array!',
            );
          }
          return (
            ...
            (h.inspect = function() {
              var t = {};
              for (var e in this)
                o.call(this, e) && (t[e] = '_nextThen' === e ? this[e] && this[e]._chain : this[e]);
              return t;
            }),
            (p.NAME = 'Thenjs'),
            (p.VERSION = '2.0.3'),
        ...
        (o.prototype = new Error()),
          ...
          t.atob ||
            (t.atob = function(t) {
              ...
              if (e.length % 4 == 1)
                throw new o("'atob' failed: The string to be decoded is not correctly encoded.");
              for (
                var r, i, s = 0, a = 0, c = '';
                (i = e.charAt(a++));
    ...
    function(t, e, n) {
      ...
      (s.prototype.init = function(t) {
        (this.opts = t),
          ...
          (this.sync_key = 0),
          (this.sync_type = 0),
          (this.client = r(this.opts.address, { transports: ['websocket', 'polling'] }));
        var e = this,
          n = o.prototype.emit,
        ...
        (s.prototype.onReceive = function(t, e) {
          if (
            (this.opts.debug && console.info('---<- event:%s, data:%s', t, JSON.stringify(e)),
            ...
            delete e.rid,
              n &&
                (0 === e.code && t === i.EVENTS.GET_GROUP_MEMBERS
                  ...
                  : 0 === e.code && t === i.EVENTS.GET_ACROSS_USER_INFO && delete e.user_info.uid,
                t === i.EVENTS.ACK
                  ? (n.ack && n.ack({ rid: e.rid, data: n.data }), n.cleanAckTimeout())
                  : (n.cleanRespTimeout(),
                    ...
                    e.code && 0 !== e.code
                      ...
                      : ((n.data.msg_id = e.msg_id),
                        t === i.EVENTS.S_SINGLE_TEXT_ &&
                          ((e.target_username = n.data.target_id), (e.appkey = n.data.appkey)),
                        n.success && n.success(e, n.data),
                        n.innerCall && n.innerCall(e.msg_id))));
          }
        }),
        (s.prototype.generateRid = function() {
          for (var t = Math.floor(-2147483646 * Math.random() + 2147483647); this.dataCache[t]; )
            t = Math.floor(-2147483646 * Math.random() + 2147483647);
          return t;
        }),
        (s.prototype.send = function(t, e) {
          this.opts.debug && console.info('---\x3e- event:%s, data:%s', t, JSON.stringify(e)),
      ...
      function c(t, e) {
        ...
        return (
          e.forceNew || e['force new connection'] || !1 === e.multiplex || h
            ...
            : (a[u] || (s('new io instance for %s', c), (a[u] = i(c, e))), (n = a[u])),
          r.query && !e.query
            ? (e.query = r.query)
            : e &&
        ...
        ((e = t.exports = n(12)).log = function() {
          ...
          (e.formatArgs = function() {
            ...
            var o = 'color: ' + this.color,
              ...
              i = 0;
            return (
              (t = [t[0], o, 'color: inherit'].concat(Array.prototype.slice.call(t, 1)))[0].replace(
                /%[a-z%]/g,
                function(t) {
                  '%%' !== t && '%c' === t && (i = ++r);
                },
      ...
      function i(t) {
        ...
        function i() {
          ...
          (t.diff = s),
            ...
            null == t.color && t.useColors && (t.color = e.colors[r++ % e.colors.length]);
                  ...
                  if (u) {
                    ...
                    try {
                      u =
                        ...
                        '"-000001-01-01T00:00:00.000Z"' == c(new i(-621987552e5)) &&
                    ...
                    if ('object' == typeof a && a)
                      if ('[object Date]' != (c = g.call(a)) || f.call(a, 'toJSON'))
                        ...
                        if (R) {
                          ...
                          (l = 1 + l - R(p, h)),
                            (m = N((y = ((a % 864e5) + 864e5) % 864e5) / 36e5) % 24),
                            (v = N(y / 6e4) % 60),
                            (E = N(y / 1e3) % 60),
                            (b = y % 1e3);
                        } else
                    ...
                    if ('object' == typeof a) {
                      ...
                      if ((s.push(a), (w = []), (L = i), (i += r), c == T)) {
                        for (I = 0, x = a.length; I < x; I++)
                          (C = D(I, a, n, o, r, i, s)), w.push(C === _ ? 'null' : C);
                        M = w.length
                          ? r
                            ? '[\n' + i + w.join(',\n' + i) + '\n' + L + ']'
                            : '[' + w.join(',') + ']'
                      ...
                      switch ((r = i.charCodeAt(I))) {
                        ...
                        case 34:
                          for (t = '@', I++; I < s; )
                            if ((r = i.charCodeAt(I)) < 32) P();
                              ...
                              if (34 == r) break;
                              for (r = i.charCodeAt(I), e = I; r >= 32 && 92 != r && 34 != r; )
                                r = i.charCodeAt(++I);
                              t += i.slice(e, I);
                            }
                        ...
                        default:
                          if (
                            ...
                            for (
                              48 == r && (r = i.charCodeAt(I + 1)) >= 48 && r <= 57 && P(), o = !1;
                            ...
                            if (101 == (r = i.charCodeAt(I)) || 69 == r) {
                              for (
                                (43 != (r = i.charCodeAt(++I)) && 45 != r) || I++, n = I;
                                n < s && (r = i.charCodeAt(n)) >= 48 && r <= 57;
                                n++
                              );
                              n == I && P(), (I = n);
                            }
    ...
    function(t, e, n) {
      (function(t) {
        ...
        (e.polling = function(e) {
          ...
          {
            if (((e.xdomain = n), (e.xscheme = s), 'open' in new o(e) && !e.forceJSONP))
              return new r(e);
        ...
        (t.exports = u),
            ...
            try {
              ...
              try {
                if (this.extraHeaders)
                  for (var i in (n.setDisableHeaderCheck(!0), this.extraHeaders))
                    this.extraHeaders.hasOwnProperty(i) &&
                      n.setRequestHeader(i, this.extraHeaders[i]);
              } catch (t) {}
              if ((this.supportsBinary && (n.responseType = 'arraybuffer'), 'POST' === this.method))
                try {
                  this.isBinary
            ...
            try {
              ...
              if ('application/octet-stream' === e) t = this.xhr.response || this.xhr.responseText;
                ...
                try {
                  ...
                  for (
                    var n = new Uint8Array(this.xhr.response), o = [], r = 0, i = n.length;
                    r < i;
                    r++
                  )
                    o.push(n[r]);
          ...
          e.document &&
            (e.attachEvent
              ...
              : e.addEventListener && e.addEventListener('beforeunload', h, !1));
      }.call(e, window));
    },
    function(t, e, n) {
      var o = n(34),
    ...
    function(t, e, n) {
      (function(t) {
        ...
        (e.encodePacket = function(n, o, r, i) {
          ...
          if (p && p.base64)
            return (s = n), (a = i), (u = 'b' + e.packets[s.type] + s.data.data), a(u);
          var f = l[n.type];
          return (
            void 0 !== n.data && (f += r ? c.encode(String(n.data)) : String(n.data)), i('' + f)
          );
        }),
          ...
          (e.encodePayload = function(t, n, o) {
            ...
            var r = i(t);
            if (n && r)
              return _ && !h ? e.encodePayloadAsBlob(t, o) : e.encodePayloadAsArrayBuffer(t, o);
          ...
          (e.decodePayload = function(t, n, o) {
            ...
            for (var i, s, a = '', c = 0, u = t.length; c < u; c++) {
              ...
              if (':' != p) a += p;
                ...
                if (s.length) {
                  if (((r = e.decodePacket(s, n, !0)), d.type == r.type && d.data == r.data))
                    return o(d, 0, 1);
            ...
            y(
              ...
              function(t, e) {
                var o = e.reduce(function(t, e) {
                    ...
                    return (
                      t +
                      (n = 'string' == typeof e ? e.length : e.byteLength).toString().length +
                      n +
                      2
                    );
                  }, 0),
    ...
    function(t, e) {
      t.exports = function(t, e, n) {
        ...
        if ((e < 0 && (e += o), n < 0 && (n += o), n > o && (n = o), e >= o || e >= n || 0 === o))
          return new ArrayBuffer(0);
        for (var r = new Uint8Array(t), i = new Uint8Array(n - e), s = e, a = 0; s < n; s++, a++)
          i[a] = r[s];
        return i.buffer;
      };
    },
          ...
          function d(t) {
            ...
            return (
              0 == (4294965248 & t)
                ...
                : 0 == (4292870144 & t) &&
                  ((e = h(((t >> 18) & 7) | 240)), (e += f(t, 12)), (e += f(t, 6))),
              (e += h((63 & t) | 128))
            );
          }
          function _() {
            ...
            decode: function(t) {
              ...
              return (function(t) {
                for (var e, n = t.length, o = -1, r = ''; ++o < n; )
                  (e = t[o]) > 65535 &&
                    ((r += h((((e -= 65536) >>> 10) & 1023) | 55296)), (e = 56320 | (1023 & e))),
                    (r += h(e));
                return r;
              })(n);
            },
                ...
                i.encodePacket(t, n.supportsBinary, function(r) {
                  if (!n.usingBrowserWebSocket) {
                    ...
                    if ((t.options && (i.compress = t.options.compress), n.perMessageDeflate))
                      ('string' == typeof r ? e.Buffer.byteLength(r) : r.length) <
    ...
    function(t, e, n) {
      ...
      r(l.prototype),
        ...
        (l.prototype.close = l.prototype.disconnect = function() {
          return (
            this.connected &&
              (c('performing disconnect (%s)', this.nsp), this.packet({ type: o.DISCONNECT })),
            this.destroy(),
      ...
      (r.prototype.setEvent = function(t) {
        ...
        (r.prototype.ackTimeoutTask = function() {
          if (this.times < o.RETRY_TIMES) {
            ...
            this.timeout && this.timeout({ rid: this.rid, data: this.data, response_timeout: !1 }),
        ...
        (r.prototype.respTimeoutTask = function() {
          if (this.times < o.RETRY_TIMES) {
            ...
            this.timeout && this.timeout({ rid: this.rid, data: this.data, response_timeout: !0 }),
              delete this.channel.dataCache[this.rid];
          return this;
        }),
    ...
    function(t, e) {
      ...
      (n.prototype.setNeedReceipt = function(t) {
        ...
        (n.prototype.setCustom = function(t, e) {
          return (
            (this.msg_type = 'custom'), (this.msg_body = t), e && (this.msg_body.extras = e), this
          );
        }),
        (n.prototype.build = function() {
          ...
          else if (((n.target_gid = e.target_id), this.at_list && this.at_list instanceof Array))
      ...
      t.exports = function() {
                            ...
                            (f = r(
                              (f = o(
                                      ...
                                      (f = n(
                                        (f = n(
                                          ...
                                          (d = n(
                                            ...
                                            (_ = n(
                                              _,
                                              (l = n(l, f, d, _, e[a + 8], 7, 1770035416)),
                                              f,
                                              d,
                                              e[a + 9],
                                              12,
                                        ...
                                        (d = n(
                                          ...
                                          (_ = n(
                                            _,
                                            (l = n(l, f, d, _, e[a + 12], 7, 1804603682)),
                                            f,
                                            d,
                                            e[a + 13],
                                            12,
                                ...
                                (d = o(
                                  ...
                                  (_ = o(
                                    _,
                                    (l = o(l, f, d, _, e[a + 13], 5, -1444681467)),
                                    f,
                                    d,
                                    e[a + 2],
                                    9,
        ...
        function u(t) {
          ...
          for (n = 0; n < t.length; n += 1)
            (e = t.charCodeAt(n)), (r += o.charAt((e >>> 4) & 15) + o.charAt(15 & e));
          return r;
        }
        function p(t) {
        ...
        function l(t, e) {
          return (function(t, e) {
            var n,
              ...
              u = [];
            for (
              i[15] = u[15] = void 0, r.length > 16 && (r = s(r, 8 * t.length)), n = 0;
              n < 16;
              n += 1
            )
          ...
          removeItems: function(t) {
            if (window.localStorage) {
              for (var e = localStorage.length, n = [], o = 0; o < e; o++)
                localStorage.getItem(localStorage.key(o)) === t && n.push(localStorage.key(o));

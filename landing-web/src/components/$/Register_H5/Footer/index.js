...
const Footer = () => {
  ...
  return (
    <div className={styles.footer} id="register_h5_footer">
      <div className={styles.iconWrap}>
        <a href={addLangToPath(`${siteConfig.KUCOIN_HOST}`)} target="_blank" rel="noopener noreferrer">
          <img src={window._BRAND_LOGO_} alt="logo" className={styles.logoImg} />
        </a>
        <div className={styles.follow}>
          <div className={styles.followWords}>{_t('register.follow')}</div>
          <a
            href="https://www.facebook.com/KuCoinOfficial"
            target="_blank"

...
const Banner = ({ namespace = 'luckydraw' }) => {
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.content}>
          <div className={styles.contentLeft}>
            ...
            <h2 className={styles.subTitle} inspector="sub_title">
              <span className={styles.subTitleText}>{content.subTitle1}</span>
              <span className={styles.subTitleNum}>{content.subTitle2}</span>
              <span className={styles.subTitleText}>{content.subTitle3}</span>
            </h2>
            <div className={styles.desGroup}>
              {content.description.map((item, index) => (
                <p inspector="description" className={styles.description} key={`des_${index}`}>
                  {item}
                </p>
              ))}
            </div>

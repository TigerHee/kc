...
import AgreeModal from '../../../Spotlight5/module/AgreeModal';
...
export default class CountryCheck2 extends React.Component {
  ...
  render() {
    const { className, country_agreement, loading, isLogin, isSignedAgreement, children } = this.props;
    ...
    return (
      <React.Fragment>
        <AgreeModal
          ...
          onAgree={this.agree}
        />
        <div className={className} onClick={this.visitModal}>
          {children((
            <React.Fragment>

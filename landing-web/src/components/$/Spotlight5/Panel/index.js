...
export default class Panel extends React.Component {
  ...
  clickScroll = () => {
    window.scrollTo({
      top: document.getElementById('spotlight5-ProjectCondition').offsetTop - 100,
      behavior: "smooth"
    })
    ...
    return (
      <div className={style.panel}>
        <GradientCard>
          ...
          />
          <div className={cls("pl-24 pr-24", style.bgColorWrap)} >
            ...
            {/* <div className={style.panelButton}><Button
              key="btn-reservation"
              type="primary"
              size="large"
              loading={reservationing}

...
import { ReactComponent as ArrowBack } from 'assets/eth-merge/arrow-left.svg';
import SHARESVG from 'assets/eth-merge/share.svg';
...
const Header = ({ goShare }) => {
  ...
  useEffect(() => {
    ...
    let scrollEl = document.getElementById('ETH_MERGE_SCROLL_EL');
    if (scrollEl) {

...
import card1Svg from 'assets/registration/card_1.svg';
import card2Svg from 'assets/registration/card_2.svg';
import card3Svg from 'assets/registration/card_3.svg';
import cryptoSvg from 'assets/registration/crypto.svg';
...
const Content = () => {
  ...
  const handleImg = useCallback(
    item => {
      imgRef.current.className = styles.rewardRight;
      setReward(item);
      setTimeout(() => {
        imgRef.current.className = classname(styles.rewardRight, styles.rightImgFadein);
      }, 300);
    },
    [imgRef],
  );
  ...
  return (
    <div className={styles.content}>
      <div inspector="reward_wrap" className={styles.rewardWrap}>
        <div className={styles.title}>{_t('register.reward.title')}</div>
        <div className={styles.reward}>
          <div className={classname(styles.rewardLeft, 'wow fadeInLeft')}>
              ...
              {rewardBtnData.map(item => (
                <div
                  className={`${styles.rewardBtn} ${
                    reward === item ? styles.rewardBtnChecked : ''
                  }`}
                  key={item}
          ...
          <img src={arrowSvg} alt="" className={styles.arrowImg} />
          <div
            ref={imgRef}
            className={classname(styles.rewardRight, styles.rightImgFadein, 'wow fadeInRight')}
          >
      ...
      <div inspector="info_wrap" className={styles.infoWrap}>
        <div className={styles.title}>{_t('register.info.title')}</div>
        <div className={styles.info}>
          <div className={classname(styles.infoItem, 'wow fadeInLeft')}>
          ...
          <div className={classname(styles.infoItem, 'wow fadeInRight')}>
      ...
      <div inspector="crypto_wrap" className={styles.cryptoWrap}>
        <div className={styles.title}>{_t('register.journey')}</div>
        <div className={styles.crypto}>
          <img src={cryptoSvg} alt="" className={classname(styles.cryptoImg, 'wow fadeInLeft')} />
          <div>
            <div className={classname(styles.cryptoItem, 'wow fadeInRight')}>
      ...
      <div inspector="media_wrap" className={styles.mediaWrap}>
        <div className={styles.title}>{_t('register.say')}</div>
        <div className={classname(styles.carouselWrap, 'wow fadeInUp')}>
          <Carousel slides={slides()} />
        </div>
      </div>

      <div inspector="faq" className={styles.faqWrap}>
        <div className={styles.title}>{_t('register.faq')}</div>

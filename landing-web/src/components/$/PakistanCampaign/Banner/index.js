...
import { handleJoin } from '../../MarketCommon/luckydrawCommon';
import { handleLogin } from 'components/$/LuckydrawTurkey/config';
...
import pakistanCampaignImg from 'assets/luckydrawTurkey/pakistanCampaign.png';
...
const Banner = ({ namespace = 'pakistanCampaign' }) => {
